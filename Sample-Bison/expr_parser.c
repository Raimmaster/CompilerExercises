...
#line 82 "expr_parser.c" /* yacc.c:339  */
...
#line 153 "expr_parser.c" /* yacc.c:358  */
...
static const char *const yytname[] =
{
  ...
  "TK_ERROR", "TK_PRINT", "TK_EQ", "TK_ID", "TK_COMMA", "KW_DEC", "KW_HEX",
  "KW_BIN", "$accept", "start", "expr", "expr_format", "expr_op", "term",
  "factor", YY_NULLPTR
};
#endif
...
{
       7,    -5,    -9,     8,     4,    -5,   -10,   -10,    -3,    18,
     -10,    -5,   -10,     1,     3,    -5,    -5,     0,    -5,    -5,
      22,   -10,   -10,    18,    18,   -10,   -10,   -10,   -10,   -10,
     -10
};
...
static const yytype_int8 yytable[] =
{
      15,    16,     5,    14,     6,    11,    15,    16,    12,    20,
       7,    22,    -7,    17,     1,    13,     2,    25,    26,    27,
       1,     0,     2,    18,    19,    15,    16,    23,    24,    29,
      30,     0,    21
};
...
static const yytype_int8 yycheck[] =
{
      ...
      15,     8,    11,    16,    13,    11,    15,    17,    18,    19,
      13,    -1,    15,     5,     6,     3,     4,    15,    16,    18,
      19,    -1,    13
};
...
static const yytype_uint8 yystos[] =
{
      ...
      26,    14,     0,    11,    24,     3,     4,    16,     5,     6,
      24,    21,     8,    25,    25,    17,    18,    19,    23,    26,
      26
};
...
#line 34 "expr.y" /* yacc.c:1646  */
    {
        if(strcmp((yyvsp[0]), "hex")) { printf("%x\n", (yyvsp[-2])); } else if(strcmp((yyvsp[0]), "dec")) { printf("%x\n", (yyvsp[-2])); } )
        else if(strcmp((yyvsp[0]), "bin")) { printf("Bin option %d\n", (yyvsp[-2])); }
        }
...
#line 1327 "expr_parser.c" /* yacc.c:1646  */
      default: break;
    }
