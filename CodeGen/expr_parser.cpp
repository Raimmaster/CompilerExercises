...
static const YYACTIONTYPE yy_action[] = {
 /*     0 */     6,   19,   20,   34,    7,   21,   22,    1,    5,   20,
 /*    10 */    20,    8,    7,    4,    3,    2,   24,    3,    2,   20,
 /*    20 */    23,    9,
};
static const YYCODETYPE yy_lookahead[] = {
 /*     0 */     9,   11,   11,   12,   13,    4,    5,    6,    9,   11,
 /*    10 */    11,   13,   13,    3,    1,    2,    0,    1,    2,   11,
 /*    20 */     7,   13,
};
...
static const YYACTIONTYPE yy_default[] = {
 /*     0 */    33,   33,   33,   33,   33,   33,   33,   27,   26,   25,
};
...
static const char *const yyTokenName[] = { 
  "$",             "OP_SUM",        "OP_SUB",        "OP_STAR",     
  "LIT_INT",       "TK_ID",         "TK_LEFT_PAR",   "TK_RIGHT_PAR",
  "error",         "expr",          "sub_expr",      "factor",      
  "input",         "sup_expr",    
};
#endif /* NDEBUG */
...
static const char *const yyRuleName[] = {
 /*   0 */ "input ::= expr",
 /*   1 */ "expr ::= expr OP_SUM sup_expr",
 /*   2 */ "expr ::= expr OP_SUB sup_expr",
 /*   3 */ "expr ::= sup_expr",
 /*   4 */ "sup_expr ::= sup_expr OP_STAR factor",
 /*   5 */ "sup_expr ::= factor",
 /*   6 */ "factor ::= LIT_INT",
 /*   7 */ "factor ::= TK_ID",
 /*   8 */ "factor ::= TK_LEFT_PAR expr TK_RIGHT_PAR",
};
#endif /* NDEBUG */
...
/********** Begin reduce actions **********************************************/
      ...
      case 0: /* input ::= expr */
#line 20 "grammar.y"
{ cout<<"Generated: "<<endl<<endl<<yymsp[0].minor.yy6->generate()<<endl; }
#line 741 "expr_parser.cpp"
        break;
      case 1: /* expr ::= expr OP_SUM sup_expr */
#line 22 "grammar.y"
{ yylhsminor.yy6 = new AddExpr(yymsp[-2].minor.yy6, yymsp[0].minor.yy6); }
#line 746 "expr_parser.cpp"
  yymsp[-2].minor.yy6 = yylhsminor.yy6;
        break;
      case 2: /* expr ::= expr OP_SUB sup_expr */
#line 23 "grammar.y"
{ yylhsminor.yy6 = new SubExpr(yymsp[-2].minor.yy6, yymsp[0].minor.yy6); }
#line 752 "expr_parser.cpp"
  yymsp[-2].minor.yy6 = yylhsminor.yy6;
        break;
      case 3: /* expr ::= sup_expr */
      case 5: /* sup_expr ::= factor */ yytestcase(yyruleno==5);
#line 24 "grammar.y"
{ yylhsminor.yy6 = yymsp[0].minor.yy6; }
#line 759 "expr_parser.cpp"
  yymsp[0].minor.yy6 = yylhsminor.yy6;
        break;
      case 4: /* sup_expr ::= sup_expr OP_STAR factor */
#line 26 "grammar.y"
{ yylhsminor.yy6 = new MulExpr(yymsp[-2].minor.yy6, yymsp[0].minor.yy6); }
#line 765 "expr_parser.cpp"
  yymsp[-2].minor.yy6 = yylhsminor.yy6;
        break;
      case 6: /* factor ::= LIT_INT */
#line 29 "grammar.y"
{ yylhsminor.yy6 = new NumberExpr(yymsp[0].minor.yy0->val); delete yymsp[0].minor.yy0; }
#line 771 "expr_parser.cpp"
  yymsp[0].minor.yy6 = yylhsminor.yy6;
        break;
      case 7: /* factor ::= TK_ID */
#line 30 "grammar.y"
{ yylhsminor.yy6 = new VarExpr(yymsp[0].minor.yy0->lexem); delete yymsp[0].minor.yy0; }
#line 777 "expr_parser.cpp"
  yymsp[0].minor.yy6 = yylhsminor.yy6;
        break;
      case 8: /* factor ::= TK_LEFT_PAR expr TK_RIGHT_PAR */
#line 31 "grammar.y"
